...
class StocksList extends StatefulWidget {
  List<StocksTable> date;
  int listType;

  StocksList(this.date, this.listType);
  ...
  _buildListItems(int index) {
    return ExpansionTile(
      ...
      leading: CircleAvatar(
        radius: 25.0,
        backgroundColor: _calculatePercent(
                  ...
                  Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            TextFa(
                              (stocks[index].sellPrice - stocks[index].buyPrice)
                                  .toStringAsFixed(2),
                              fontSize: 12.0,
                            ),
                            Tooltip(
